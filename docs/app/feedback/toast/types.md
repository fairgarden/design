...
[//]: types.ts '<-- Autogenerated By (do not edit the following markdown directly), run: pnpm docs:validate feedback/toast'
...
| timeout      | `number`                                                                                                                                                                                                                                                                                                                                   | -       | Default auto-dismiss time in ms, at least 6000 (--fgd-duration-toast).&#xA;Timers pause on hover, on focus and while the tab is hidden. |
