...
- **Logo:** `--ds-size-logo`, the logo mark in a lockup beside the wordmark: `--ds-size-control-md` (40 px), `--size-px-8` (48 px) from `--lg-n-above`, and `--size-px-7` (32 px) below `--xs-n-below`, so it fills the header bar's control height.
