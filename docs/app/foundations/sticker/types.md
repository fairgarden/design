...
[//]: types.ts '<-- Autogenerated By (do not edit the following markdown directly), run: pnpm docs:validate foundations/sticker'
...
| size      | `StickerSize`                                                                                                                                                                                                                                                                                                                                      | -       | `s` (default): `--fgd-size-art-s`, 152 px. `l`: `--fgd-size-art-l`, 312 px.                                                                                                                                                                                                                    |
