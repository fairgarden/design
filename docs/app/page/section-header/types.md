...
| kind      | `'editorial' \| 'trailed' \| 'scene' \| 'anchored' \| 'technical' \| 'topic'`                                                                                                                                                                                                                                                                      | -       | `editorial` (default): eyebrow, hairline, content. With an&#xA;eyebrow the header opens with its rule, so the band needs no&#xA;page-seam hairline above it \[D179].                   |
| lede      | `React.ReactNode`                                                                                                                                                                                                                                                                                                                                  | -       | Why it matters: `type-lead` in `--primary12`, capped at `--fgd-measure-reading`.                                                                                                       |
