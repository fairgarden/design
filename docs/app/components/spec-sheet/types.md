...
[//]: types.ts '<-- Autogenerated By (do not edit the following markdown directly), run: pnpm docs:validate components/spec-sheet'
...
| provenance   | `React.ReactNode`                                                                                                                                                                                                                                                                                                                                  | -       | The provenance line, `type-small`: "Text adapted from _Lives of North&#xA;American Birds_". Set book titles in `<cite>`; a linked title takes the&#xA;body link's underline.                                                                                                                                                                   |
