...
[//]: types.ts '<-- Autogenerated By (do not edit the following markdown directly), run: pnpm docs:validate components/meter'
...
| threshold   | `number`                                                                                                                                                                                                                                                                                                                                           | -       | A limit, drawn as a --ds-space-12 tick at --border-size-2 across the track (`bar`).                                                                                                                                                                                                           |
